...
Shared game context is included by SDK 3.0.0 without a scope. Use `gameContext(state)` from `@w3booster/sdk/selectors` for HUD scale (default 1), chat visibility, and team-color mode. Do not request the retired `overlay:read` scope.

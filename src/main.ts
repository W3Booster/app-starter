...
for (const [text, href] of [['Build your own', 'https://w3booster.com/developer/first-app/'], ['View source', 'https://github.com/W3Booster/app-starter'], ['SDK reference', 'https://w3booster.com/developer/api/']]) {
